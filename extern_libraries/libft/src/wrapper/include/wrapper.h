...
/*   Updated: 2025/03/20 21:17:25 by rjw           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#ifndef WRAPPER_H
# define WRAPPER_H
//	define or add it to CFLAGS += -D_GNU_SOURCE
 ...
 * @param[in] ...: Optional mode_t argument for file permissions
 * 				   (if O_CREAT is used).
 *
